...
Route::group(array('middleware'=>['auth']), function() {
		...
		Route::post('medicine/updated', [MedicineController::class, 'updated'])->name('medicine.updated');

		
		Route::post('prescription', ['as'=>'prescription.store', 'uses'=>'InvoiceController@store']);
		...
		Route::get('prescriptions/add', 'PrescriptionController@add')->name('prescriptions.add');
		Route::post('prescriptions', 'PrescriptionController@store')->name('prescriptions.store');
		Route::get('prescriptions/{prescription}', 'PrescriptionController@show')->name('prescriptions.show');
		Route::get('prescriptions/{prescription}/edit', 'PrescriptionController@edit')->name('prescriptions.edit');
		Route::put('prescriptions/{prescription}', 'PrescriptionController@update')->name('prescriptions.update');
		Route::delete('prescriptions/{prescription}', 'PrescriptionController@destroy')->name('prescriptions.destroy');


		Route::get('/registers', 'RegisterController@index')->name('registers.index');
		Route::get('/registers/create', 'RegisterController@create')->name('registers.create');
		Route::post('/registers', 'RegisterController@store')->name('registers.store');
		Route::get('/registers/{register}', 'RegisterController@show')->name('registers.show');
		Route::get('/registers/{register}/edit', 'RegisterController@edit')->name('registers.edit');
		Route::put('/registers/{register}', 'RegisterController@update')->name('registers.update');
		Route::delete('/registers/{register}', 'RegisterController@destroy')->name('registers.destroy');

		Route::get('/diseases', 'DiseaseController@index')->name('diseases.index');
		Route::get('/diseases/create', 'DiseaseController@create')->name('diseases.create');
		...
		Route::get('/diseases/{disease}/edit', 'DiseaseController@edit')->name('diseases.edit');
