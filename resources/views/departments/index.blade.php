	...
	<div class="row">
		<div class="col-md-8">
			<div class="panel panel-default">
				<div class="panel-heading">Danh sách chuyên khoa <a class="btn btn-sm btn-primary pull-right" href="{{url('/')}}">Quay lại <span class="glyphicon glyphicon-share-alt"></span></a></div>
		...
		<div class="panel panel-default">
				<div class="panel-heading">Thêm chuyên khoa</div>
				<div class="panel-body">
