    ...
    <div class="col-md-12 main">           
                ...
                <div class="panel panel-orange panel-widget">
                    <div class="row no-padding">
                        ...
                        <div class="col-sm-10 col-lg-9 widget-right">
                            ...
                            <div class="text-muted">Số cuộc hẹn đang chờ</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="panel panel-teal panel-widget">
                    <div class="row no-padding">
                        ...
                        <div class="col-sm-9 col-lg-7 widget-right">
                            ...
                            <div class="text-muted">Tổng xét nghiệm</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <!-- Appointment for today -->
             <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Lịch hẹn hôm nay</div>
                         ...
                         <table id="table1" class="display table table-bordered table-condensed table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a class="btn-sm btn-success" href="{{ route('appointment.edit',$appointment->id) }}"><span class=" glyphicon glyphicon-ok"></span> Đã khám</a>    
                                    @else
                                    <a class="btn-sm btn-warning" href="{{ route('appointment.edit',$appointment->id) }}"><span class=" glyphicon glyphicon-refresh"> </span> Chờ khám</a>
                                    @endif
                                    </td>
                                </tr>
                                @endforeach
            ...
            <!-- Today invoice collection -->
                <div class="panel panel-default">
                    <div class="panel-heading">Thu nhập hôm nay</div>
                    <div class="panel-body">
                            ...
                            @foreach($invoices as $invoice)
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <th>Tổng:</th>
                                    <th></th>
                                    <th>{{$total['sub_total']}}</th>
                                    <th>{{$total['discount']}}</th>
                                    <th>{{$total['tax_amount']}}</th>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Khám dịch vụ hôm nay</div>
                    <div class="panel-body">
                         <table id="example" class="display table table-bordered table-condensed table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td>{{$opd->invoice->patient->last_name}} {{$opd->invoice->patient->first_name}}</td>
                                    <td>{{$opd->doctor->employee->last_name}} {{$opd->doctor->employee->middle_name}} {{$opd->doctor->employee->first_name}}</td>
                                    @if($opd->status == 1)
                                    <td><span class="btn-sm btn-success glyphicon glyphicon-ok"> Đã khám</span></td>
                                    @else
                                    <td><a class="btn-sm btn-warining" href="{{ route('doctor.edit',$opd->id) }}"><span class=" glyphicon glyphicon-refresh"> Chờ khám</span></a> </span></td>
                                    @endif
                                </tr>
                                @endforeach
                            </tbody>                 
