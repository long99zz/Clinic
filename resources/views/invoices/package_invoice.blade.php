...
<div class="col-lg-12 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Hoá đơn gói khám</li>
		</ol>
	</div><br><!--/.row-->
<!-- Modal -->
    ...
    @endif
		<div class="row">
			<div class="col-lg-12">
                ...
                <div class="panel-heading"><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span>Hoá đơn gói khám</div>
	 		 			...
	 		 			<div class="col-md-4">
                            ...
                            <div class="col-md-12">
		 		 			...
		 		 			<p>--------------------------------------------------------------------</p>
		 		 				...
		 		 				<a href="{{url('package/sale')}}" class="btn btn-default">Đặt lại</a>
		 		 			</div>	
						</div>
 		 			</div>
 		 			</div>
...
$(document).ready(function() {
    ...
    $('#calculate').click(function(){
        ...
        if(cash > 0)
        {
        	...
        	$('#complete').show();
    		$('#comment').show();
    		$('#tender').html('<strong>Tổng phụ: '+ sub_total +'</strong><br><strong>Giảm giá:'+ discount + '</strong><br><b>------------------------------</b><br><strong>Phụ thu:' + total+'</strong><br><strong>HST('+ tax+'%): '+ tax_amount +'</strong><br><b>-----------------------------<b><br><strong>Tổng thu: '+ total_amount +'</strong><br><strong>Thanh toán: ' + cash + '</strong><br><strong>Hoàn lại:' + tender_amount+ '</strong>');
    		$('#tender').show();
    		}  
    	}
        else
        {
        	$('#msg').show();
        	$("#msg").html("<div style='color:red;margin-bottom: 20px;'><span class='btn-sm alert-danger'>Chưa nhập số tiền thanh toán ...</span></div>");
